...
const defaultQuestionnaire: QuestionnaireItem[] = [
    { srNo: 1, particulars: "Any delay/default in debt servicing on Commercial Paper (CP) instruments.", remarks: "" },
    { srNo: 2, particulars: "Any non-adherence with the terms and conditions of the CP issuance.", remarks: "" },
    { srNo: 3, particulars: "Any other adverse observation from IPA's perspective.", remarks: "" },
    { srNo: 4, particulars: "Any other information you would like to share with us?", remarks: "" },
];
...
export default function IPAFeedbackCapturePage() {
    ...
    const { data, error, isLoading } = useSWR<{ firm: IPAFirm, contact: IPAContact }>(
        companyId && firmId && contactId ? `/api/due-diligence/ipa-feedback?companyId=${companyId}&firmId=${firmId}&contactId=${contactId}` : null,
        fetcher
    );
                 ...
                 <div className="flex items-center gap-4 mb-4">
                    ...
                    <div>
                        <h1 className="text-xl font-bold tracking-tight text-foreground">
                            IPA Feedback Capture: {firm.firmName}
                        </h1>
                         ...
                         {!isReadOnly && (
                            <>
                                <Button type="button" variant="outline" onClick={() => setIsEmailModalOpen(true)}>
                                    <Mail className="mr-2 h-4 w-4" />Email to IPA
                                </Button>
