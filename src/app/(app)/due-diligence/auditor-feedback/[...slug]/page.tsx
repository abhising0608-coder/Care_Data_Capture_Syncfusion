...
const defaultQuestionnaire: QuestionnaireItem[] = [
    { srNo: 1, particulars: "Any qualification or adverse remark in the audit report of the Company during the last three years.", remarks: "" },
    { srNo: 2, particulars: "Any instances of non-cooperation by the Company during the audit process.", remarks: "" },
    { srNo: 3, particulars: "Any major issues pending with the Company from an accounting or compliance perspective.", remarks: "" },
...
export default function AuditorFeedbackCapturePage() {
    ...
    const { data, error, isLoading } = useSWR<{ firm: AuditorFirm, contact: AuditorContact }>(
        companyId && firmId && contactId ? `/api/due-diligence/auditor-feedback?companyId=${companyId}&firmId=${firmId}&contactId=${contactId}` : null,
        fetcher
    );
                 ...
                 <div className="flex items-center gap-4 mb-4">
                    ...
                    <div>
                        <h1 className="text-xl font-bold tracking-tight text-foreground">
                            Auditor Feedback Capture: {firm.firmName}
                        </h1>
                         ...
                         {!isReadOnly && (
                            <>
                                <Button type="button" variant="outline" onClick={() => setIsEmailModalOpen(true)}>
                                    <Mail className="mr-2 h-4 w-4" />Email to Auditor
                                </Button>
