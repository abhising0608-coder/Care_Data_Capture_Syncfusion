...
export function PressReleasePreview({ note, onEdit, onClose, onSubmit }: PressReleasePreviewProps) {
  ...
  const handleSendToQc = (qcUser: {id: string, name: string}) => {
    toast({
      title: 'Sent to QC',
      description: `Press Release for ${note.companyName} has been sent to ${qcUser.name} for review.`,
    });
    setIsQcModalOpen(false);
    // Here you would add logic to update the note status
  };
          ...
          <div className="flex items-center gap-2">
              <DropdownMenu>
                  ...
                  <DropdownMenuContent align="end">
                      ...
                      <DropdownMenuItem onClick={() => setIsQcModalOpen(true)}>Send to QC</DropdownMenuItem>
                      <DropdownMenuSeparator />
