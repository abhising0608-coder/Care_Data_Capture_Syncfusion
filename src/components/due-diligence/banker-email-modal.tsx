...
import type { CompanyDashboard, BankerFirm, BankerContact, QuestionnaireItem } from '@/lib/definitions';
...
interface BankerEmailModalProps {
    ...
    onClose: () => void;
    firm: BankerFirm;
    contact: BankerContact;
    company: CompanyDashboard;
}

const generateEmailBody = (contact: BankerContact, questionnaire?: QuestionnaireItem[]): string => {
...
export function BankerEmailModal({ isOpen, onClose, firm, contact, company }: BankerEmailModalProps) {
            ...
            <DialogContent className="sm:max-w-3xl">
                <DialogHeader>
                    <DialogTitle>Email Confirmation</DialogTitle>
                     <DialogDescription>
                        Review and send the email to the Banker.
                    </DialogDescription>
                </DialogHeader>
