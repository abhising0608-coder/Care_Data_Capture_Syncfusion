...
const generateEmailBody = (contact: DTContact, questionnaire?: QuestionnaireItem[]): string => {
...
export function DTEmailModal({ isOpen, onClose, firm, contact, company }: DTEmailModalProps) {
            ...
            <DialogContent className="sm:max-w-3xl">
                <DialogHeader>
                    <DialogTitle>Email Confirmation</DialogTitle>
                     <DialogDescription>
                        Review and send the email to the Debenture Trustee.
                    </DialogDescription>
                </DialogHeader>
