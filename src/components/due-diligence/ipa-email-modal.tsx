...
import type { CompanyDashboard, IPAFirm, IPAContact, QuestionnaireItem } from '@/lib/definitions';
...
const generateEmailBody = (contact: IPAContact, questionnaire?: QuestionnaireItem[]): string => {
...
export function IpaEmailModal({ isOpen, onClose, firm, contact, company }: IpaEmailModalProps) {
            ...
            <DialogContent className="sm:max-w-3xl">
                <DialogHeader>
                    <DialogTitle>Email Confirmation</DialogTitle>
                     <DialogDescription>
                        Review and send the email to the Issuing and Paying Agent.
                    </DialogDescription>
                </DialogHeader>
